...
- [ ] Support transport of subobjects and quotient-related data
- [ ] Add transport lemmas for finite and ordered structures
- [ ] Add round-trip lemmas showing transported data is unchanged up to the expected equality
