...
- [ ] Continue downstream-driven unbundled set complete-lattice wrappers beyond the current indexed reindexing, list, range, monotone-range, family distributivity, preimage, image-over-supremum, and binary-family API
