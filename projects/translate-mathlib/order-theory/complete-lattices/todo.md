...
- [ ] Continue downstream-driven unbundled set complete-lattice wrappers beyond the current indexed, list, range, monotone-range, distributivity, preimage, and image-over-supremum API
